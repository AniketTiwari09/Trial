...
const { validateBooking, validateBookingId, validateBookingAvailability } = require('../middlewares/validator');
...
//since we have court id 
router.get('/:id/new', validateId, isLoggedIn, controller.new);

router.post("/", isLoggedIn, validateBooking, validateBookingAvailability, validateResult, controller.create);

router.get('/:id', validateId, controller.show);

router.get('/:id/new/:date', validateId, isLoggedIn, controller.chooseDate);


router.get('/:id/edit', validateId, isLoggedIn, isCreator, controller.edit);

router.put('/:id', validateId, isLoggedIn, isCreator,  validateBooking, validateBookingAvailability, validateResult,controller.update);
